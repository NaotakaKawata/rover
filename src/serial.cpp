...
void serial_callback(const std_msgs::String& serial_msg){
    //ROS_INFO("receive cmd = %s", serial_msg.data.c_str());
    cmd_msg.data = serial_msg.data;
...
int main(int argc, char **argv)
{
    ...
    //serial_pub = n.advertise<std_msgs::String>("Serial_in", 10);
		serial_pub = n.advertise<std_msgs::String>("/commnad_serial", 10);
    //timer
    ...
    //Subscriber
    ros::Subscriber serial_sub = n.subscribe("/command", 10, serial_callback);
